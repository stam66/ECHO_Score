...
CREATE TABLE `access_requests`( 
	...
	`request_status` TinyInt( 4 ) NULL DEFAULT NULL,
...
CREATE TABLE `case_videos`( 
	...
	`video_order` Int( 11 ) NULL DEFAULT 0,
...
-- CREATE TABLE "cases" ----------------------------------------
CREATE TABLE `cases`( 
	`case_id` Int( 11 ) AUTO_INCREMENT NOT NULL,
	...
	`lv_size_dilated` TinyInt( 4 ) NULL DEFAULT NULL,
	`lv_function_impaired` TinyInt( 4 ) NULL DEFAULT NULL,
	`rv_size_dilated` TinyInt( 4 ) NULL DEFAULT NULL,
	`rv_function_impaired` TinyInt( 4 ) NULL DEFAULT NULL,
	`aortic_stenosis_significant` TinyInt( 4 ) NULL DEFAULT NULL,
	`aortic_regurgitation_significant` TinyInt( 4 ) NULL DEFAULT NULL,
	`mitral_stenosis_significant` TinyInt( 4 ) NULL DEFAULT NULL,
	`mitral_regurgitation_significant` TinyInt( 4 ) NULL DEFAULT NULL,
	`tricuspid_stenosis_significant` TinyInt( 4 ) NULL DEFAULT NULL,
	`tricuspid_regurgitation_significant` TinyInt( 4 ) NULL DEFAULT NULL,
	`pericardial_effusion_significant` TinyInt( 4 ) NULL DEFAULT NULL,
	`ivc_high_ra_pressure` TinyInt( 4 ) NULL DEFAULT NULL,
	`correct_conclusions` Text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
	`requires_full_echo` TinyInt( 4 ) NULL DEFAULT NULL,
...
CREATE TABLE `mcq_options`( 
	...
	`order_num` Int( 11 ) NULL DEFAULT 0 COMMENT 'Display order (A=0, B=1, C=2, etc)',
...
CREATE TABLE `mcq_questions`( 
	...
	`order_num` Int( 11 ) NULL DEFAULT 0 COMMENT 'Display order within case (0-based)',
	...
	`points` Int( 11 ) NULL DEFAULT 1 COMMENT 'Points awarded for correct answer',
...
CREATE TABLE `user_mcq_responses`( 
	`response_id` Int( 11 ) AUTO_INCREMENT NOT NULL,
	`user_response_id` Int( 11 ) NOT NULL COMMENT 'Links to user_responses.response_id',
	`question_id` Int( 11 ) NOT NULL,
	...
	`points_earned` Int( 11 ) NULL DEFAULT 0 COMMENT 'Points earned for this question',
...
CREATE TABLE `user_responses`( 
	...
	`mcq_score` Int( 11 ) NULL DEFAULT NULL COMMENT 'Score from MCQ questions only',
	`checkbox_score` Int( 11 ) NULL DEFAULT NULL COMMENT 'Score from checkbox questions only (existing score column will be total)',
