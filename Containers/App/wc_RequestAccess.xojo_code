...
Begin wc_base wc_RequestAccess
   Compatibility   =   ""
   ControlCount    =   0
   ControlID       =   ""
   CSSClasses      =   ""
   ...
   Begin WebRectangle RectWhite
      ...
      _mDesignWidth   =   0
      _mPanelIndex    =   -1
      Begin WebButton btnSubmitRequest
         ...
         _mPanelIndex    =   -1
      End
      Begin WebTextField txtFullName
      ...
      Begin WebLabel lblInfo
         ...
         TabPanelIndex   =   0
         TabStop         =   True
         Text            =   "After submitting your request, the admin team will review and grant access if entitled. A valid email is required."
         TextAlignment   =   0
         TextColor       =   &c79797900
         Tooltip         =   ""
         Top             =   329
...
#tag WindowCode
	#tag Event
		Sub Opening()
		  ' *******************************************************************************
		  ' wc_RequestAccess.Opening event
		  ' *******************************************************************************
		  ...
		  Self.SectionTitle = "Request Access to ECHOscore"
...
#tag Events btnSubmitRequest
	...
	#tag EndEvent
#tag EndEvents
#tag Events txtFullName
	#tag Event
		Sub TextChanged()
		  btnSubmitRequest.Enabled = txtFullName.Text.Trim <> "" and txtEmail.Text.Trim <> ""
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events txtEmail
