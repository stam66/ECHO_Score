...
Begin wc_base wc_CaseReview
   ...
   Begin WebButton btnNextVideo
      ...
      _mPanelIndex    =   -1
   End
   Begin WebButton btnReplayVideo
      AllowAutoDisable=   False
      Cancel          =   False
      Caption         =   "⟳ Replay"
      ControlID       =   ""
