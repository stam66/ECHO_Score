...
#tag WindowCode
	...
	#tag Method, Flags = &h21
		Private Sub LoadGroups()
		  ' ******************************************************************
		  ' LoadGroups Method
		  ' Loads active groups from available_groups table
		  ' ******************************************************************
		  cmbGroup.RemoveAllRows
		  cmbGroup.AddRow("(No group)")
		  
		  ' Load from available_groups table - the authoritative source
		  ...
		  Try
		    ...
		    While Not rs.AfterLastRow
		      cmbGroup.AddRow(rs.Column("group_name").StringValue)
		      rs.MoveToNextRow
		    Wend
...
#tag Events btnOK
	#tag Event
		Sub Pressed()
		  ...
		  ' Create the case - include case_groups field
		  Var sql As String = "INSERT INTO cases (serial_number, case_label, case_groups) VALUES (?, ?, ?)"
		  ...
		  Try
		    ...
		    ps.Bind(2, selectedGroup)  ' Save the group to case_groups field
		    
		    ps.ExecuteSQL
		    
		    MessageBox("Case created successfully!" + If(selectedGroup <> "", EndOfLine + "Assigned to group: " + selectedGroup, ""))
		    Self.Close
